(function() {
    ...
    angular
        .module('gongrenOps')
        .controller('cooCustomerListController', cooCustomerListController);

    /** @ngInject */
    function cooCustomerListController(notify, $sce, $resource, $compile, $scope, $state, commDict, paginationNum, $stateParams, xxCacheSrv, ModalService) {
        var vm = this;
        ...
        vm.importFile = function() {
            ModalService.showModal({
                templateUrl: "app/modules/cooCustomerManage/import.html",
        ...
        vm.todoDetail = function(row) {
            ModalService.showModal({
                templateUrl: "app/modules/cooCustomerManage/todoDetail.html",
                controller: "cooTodoDetailController",
                controllerAs: "modal",
                inputs: {
                    info: row
                }
