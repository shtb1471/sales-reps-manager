(function() {
    ...
    angular
        .module('gongrenOps')
        .controller('bargainManageListController', bargainManageListController);

    /** @ngInject */
    function bargainManageListController(notify, $sce, $resource, $compile, $scope, $state, commDict, paginationNum, $stateParams, xxCacheSrv, ModalService) {
        var vm = this;
